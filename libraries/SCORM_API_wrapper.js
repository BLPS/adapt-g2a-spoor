...
(function(root, factory) {
  ...
  pipwerks.SCORM.API.find = function(win) {
    ...
    const trace = pipwerks.UTILS.trace;
  ...
  pipwerks.SCORM.connection.terminate = function() {
    ...
    let success = false;
    const scorm = pipwerks.SCORM;
    const exitStatus = scorm.data.exitStatus;
    const completionStatus = scorm.data.completionStatus;
    const trace = pipwerks.UTILS.trace;
    const makeBoolean = pipwerks.UTILS.StringToBoolean;
    const debug = scorm.debug;
